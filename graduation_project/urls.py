...
urlpatterns = [
    ...
    url(r'^practice_choice/$', student_views.practice_choice, name='practice_choice_details'),
    url(r'^practice_fill/$', student_views.practice_fill, name='practice_fill_details'),
