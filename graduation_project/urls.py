...
# 论坛模块
    ...
    url(r'^administrator_choice_list/$', administrator_views.administrator_choice_list, name='administrator_choice_list'),
    url(r'^administrator_fill_list/$', administrator_views.administrator_fill_list, name='administrator_fill_list'),
    ...
    url(r'^administrator_student_delete/$', administrator_views.administrator_student_delete, name='administrator_student_delete'),
    url(r'^administrator_teacherlist/$', administrator_views.administrator_teacherlist, name='administrator_teacherlist'),
    url(r'^administrator_teacher_delete/$', administrator_views.administrator_teacher_delete, name='administrator_teacher_delete'),
    ...
    url(r'^first_exam_edit/$', teacher_views.first_exam_edit, name='first_exam_edit'),
    url(r'^second_exam/$', teacher_views.second_exam, name='second_exam'),
    url(r'^second_exam_edit/$', teacher_views.second_exam_edit, name='second_exam_edit'),
    url(r'^third_exam/$', teacher_views.third_exam, name='third_exam'),
    url(r'^third_exam_edit/$', teacher_views.third_exam_edit, name='third_exam_edit'),
    url(r'^final_exam/$', teacher_views.final_exam, name='final_exam'),
    url(r'^final_exam_edit/$', teacher_views.final_exam_edit, name='final_exam_edit'),
    url(r'^practice_edit/$', teacher_views.practice_edit, name='practice_edit'),
    ...
    url(r'^course_end/$', teacher_views.course_end, name='course_end'),
    url(r'^delete_course/$', teacher_views.delete_course, name='delete_course'),
    url(r'^delete_Q_1/$', teacher_views.delete_Q_1, name='delete_Q_1'),
    url(r'^delete_Q_2/$', teacher_views.delete_Q_2, name='delete_Q_2'),
    url(r'^delete_Q_3/$', teacher_views.delete_Q_3, name='delete_Q_3'),
    url(r'^delete_Q_4/$', teacher_views.delete_Q_4, name='delete_Q_4'),
