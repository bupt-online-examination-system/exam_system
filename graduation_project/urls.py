...
# 论坛模块
    ...
    url(r'^administrator_test_list/$', administrator_views.administrator_test_list, name='administrator_test_list'),
    ...
    url(r'^administrator_test_list_finished/$', administrator_views.administrator_test_list_finished, name='administrator_test_list_finished'),
    url(r'^administrator_test_list_unfinished/$', administrator_views.administrator_test_list_unfinished, name='administrator_test_list_unfinished'),
